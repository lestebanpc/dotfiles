...
"###################################################################################
" Settings> IDE > Package: CoC (LSP Client, Complete y muchos complementos de 3ros)
"###################################################################################
...
" Remap <C-f> and <C-b> for scroll float windows/popups (has('nvim-0.4.0') || has('patch-8.2.0750'))
