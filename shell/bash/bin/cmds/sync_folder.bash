...
declare -A gA_local_path=(
        ['gnote_it']="$HOME/vaults/notes/it_disiplines"
        ['gnote_sciences']="$HOME/vaults/notes/sciences_and_disiplines"
        ['gnote_management']="$HOME/vaults/notes/management_disiplines"
        ['gnote_transient']="$HOME/vaults/notes/transient"
        ['ggraphics']="$HOME/vaults/graphics"
        ['gsecret_personal']="$HOME/secrets/personal"
        ['onote_it']="$HOME/vaults/notes/it_disiplines"
        ['onote_sciences']="$HOME/vaults/notes/sciences_and_disiplines"
        ['onote_management']="$HOME/vaults/notes/management_disiplines"
        ['onote_transient']="$HOME/vaults/notes/transient"
        ['ographics']="$HOME/vaults/graphics"
        ['osecret_personal']="$HOME/vaults/secrets/personal"
...
declare -A gA_remote_path=(
        ...
        ['gnote_transient']="/vaults/notes/transient"
        ['ographics']="/vaults/graphics"
        ...
        ['onote_transient']="/vaults/notes/transient"
        ['ographics']="/vaults/graphics"
