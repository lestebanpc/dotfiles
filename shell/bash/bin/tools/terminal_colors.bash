...
print_ls_colors() {
    ...
    printf '\n\nLa forma mas facil de cambiar la variable "%bLSCOLORS%b" es usando el archivo de configuración de %bdircolors%b.\n' \
           "$g_color_gray1" "$g_color_reset" "$g_color_gray1" "$g_color_reset"
    printf 'Por ejemplo, si usa el archivo %b~/.dircolors%b, use: %beval "$(dircolors -b %b~/.dircolors%b)"%b\n' "$g_color_gray1" "$g_color_reset" \
           "$g_color_cian1" "$g_color_gray1" "$g_color_cian1" "$g_color_reset"
}
