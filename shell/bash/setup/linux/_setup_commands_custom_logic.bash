...
function _copy_artifact_files() {
    ...
    case "$p_repo_id" in
        ...
        bat)
            ...
            if [ $p_install_win_cmds -ne 0 ]; then
                echo "Copiando \"autocomplete/bat.bash\" a \"~/.files/shell/bash/autocomplete/\" ..."
                cp "${l_path_source}/autocomplete/bat.bash" ${g_path_base}/.files/shell/bash/autocomplete/bat.bash
                echo "Copiando \"autocomplete/_bat.ps1\" a \"~/.files/shell/powershell/autocomplete/\" ..."
                cp "${l_path_source}/autocomplete/_bat.ps1" ${g_path_base}/.files/shell/powershell/autocomplete/bat.ps1

                if [ ! -z "$g_other_calling_user" ]; then
                    chown $g_other_calling_user ${g_path_base}/.files/shell/bash/autocomplete/bat.bash
                    chown $g_other_calling_user ${g_path_base}/.files/shell/powershell/autocomplete/bat.ps1
                fi
            fi
            ;;
        ...
        ripgrep)
            ...
            #Copiar los script de completado
            if [ $p_install_win_cmds -ne 0 ]; then
                echo "Copiando \"complete/rg.bash\" a \"~/.files/shell/bash/autocomplete/\" ..."
                cp "${l_path_source}/complete/rg.bash" ${g_path_base}/.files/shell/bash/autocomplete/rg.bash
                echo "Copiando \"complete/_rg.ps1\" a \"~/.files/shell/powershell/autocomplete/\" ..."
                cp "${l_path_source}/complete/_rg.ps1" ${g_path_base}/.files/shell/powershell/autocomplete/rg.ps1

                if [ ! -z "$g_other_calling_user" ]; then
                    chown $g_other_calling_user ${g_path_base}/.files/shell/bash/autocomplete/rg.bash
                    chown $g_other_calling_user ${g_path_base}/.files/shell/powershell/autocomplete/rg.ps1
                fi
            fi
            ;;
        ...
        delta)
            ...
            #    echo "Copiando \"complete/rg.bash\" a \"~/.files/shell/bash/autocomplete/\" ..."
            #    cp "${l_path_source}/complete/rg.bash" ${g_path_base}/.files/shell/bash/autocomplete/rg.bash
            #    echo "Copiando \"autocomplete/_rg.ps1\" a \"~/.files/shell/powershell/autocomplete/\" ..."
            #    cp "${l_path_source}/complete/_rg.ps1" ${g_path_base}/.files/shell/powershell/autocomplete/rg.ps1
            #fi
            ;;
        ...
        fzf)
            ...
            if [ $p_install_win_cmds -ne 0 ]; then
                ...
                if [ $p_artifact_index -eq 1 ]; then
                    ...
                    #Copiar los script de completado
                    echo "Copiando el script \"./shell/completion.bash\" como \"~/.files/shell/bash/autocomplete/fzf.bash\" ..."
                    cp "${l_path_source}/shell/completion.bash" "${g_path_base}/.files/shell/bash/autocomplete/fzf.bash"
            
                    echo "Copiando el script \"./shell/completion.zsh\" como \"~/.files/shell/zsh/autocomplete/fzf.zsh\" ..."
                    cp "${l_path_source}/shell/completion.zsh" "${g_path_base}/.files/shell/zsh/autocomplete/fzf.zsh"

                    #Copiar los script de keybindings
                    echo "Copiando el script \"./shell/key-bindings.bash\" como \"~/.files/shell/bash/keybindings/fzf.bash\" ..."
                    cp "${l_path_source}/shell/key-bindings.bash" "${g_path_base}/.files/shell/bash/keybindings/fzf.bash"
            
                    echo "Copiando el script \"./shell/key-bindings.fish\" como \"~/.files/shell/fish/keybindings/fzf.fish\" ..."
                    cp "${l_path_source}/shell/key-bindings.fish" "${g_path_base}/.files/shell/fish/keybindings/fzf.fish"
            
                    echo "Copiando el script \"./shell/key-bindings.zsh\" como \"~/.files/shell/zsh/keybindings/fzf.zsh\" ..."
                    cp "${l_path_source}/shell/key-bindings.zsh" "${g_path_base}/.files/shell/zsh/keybindings/fzf.zsh"
                    ...
                    if [ ! -z "$g_other_calling_user" ]; then
                        ...
                        chown $g_other_calling_user ${g_path_base}/.files/shell/bash/autocomplete/fzf.zsh
                        chown $g_other_calling_user ${g_path_base}/.files/shell/bash/keybindings/fzf.bash
                        chown $g_other_calling_user ${g_path_base}/.files/shell/bash/keybindings/fzf.fish
        ...
        jq)
            ...
            #Copiar los script de completado
            #echo "Copiando \"autocomplete/jq.bash\" a \"~/.files/shell/bash/autocomplete/\" ..."
            #cp "${l_path_source}/autocomplete/jq.bash" ${g_path_base}/.files/shell/bash/autocomplete/jq.bash
            #echo "Copiando \"autocomplete/_jq.ps1\" a \"~/.files/shell/powershell/autocomplete/\" ..."
            #cp "${l_path_source}/autocomplete/jq.ps1" ${g_path_base}/.files/shell/powershell/autocomplete/jq.ps1
            ;;
        ...
        oh-my-posh)
            ...
            if [ $p_install_win_cmds -ne 0 ]; then
                ...
                if [ $p_artifact_index -eq 0 ]; then
                    ...
                    #Copiar los script de completado
                    #echo "Copiando \"autocomplete/yq.bash\" a \"~/.files/shell/bash/autocomplete/\" ..."
                    #cp "${l_path_source}/autocomplete/yq.bash" ${g_path_base}/.files/shell/bash/autocomplete/yq.bash
                    #echo "Copiando \"autocomplete/_yq.ps1\" a \"~/.files/shell/powershell/autocomplete/\" ..."
                    #cp "${l_path_source}/autocomplete/yq.ps1" ${g_path_base}/.files/shell/powershell/autocomplete/yq.ps1

                #Instalación del tema
                else

                    mkdir -p ${g_path_base}/.files/etc/oh-my-posh/themes
                    cp -f ${l_path_source}/*.json ${g_path_base}/.files/etc/oh-my-posh/themes

                    if [ ! -z "$g_other_calling_user" ]; then
                        chown -R $g_other_calling_user ${g_path_base}/.files/etc/oh-my-posh/themes
                    fi
        ...
        zoxide)
            ...
            if [ $p_install_win_cmds -ne 0 ]; then
                ...
                echo "Copiando \"./completions/zoxide.bash\" a \"~/.files/shell/bash/autocomplete/\" ..."
                cp "${l_path_source}/completions/zoxide.bash" ${g_path_base}/.files/shell/bash/autocomplete/zoxide.bash

                echo "Copiando \"./completions/zoxide.fish\" a \"~/.files/shell/fish/autocomplete/\" ..."
                cp "${l_path_source}/completions/zoxide.fish" ${g_path_base}/.files/shell/fish/autocomplete/zoxide.fish
                
                echo "Copiando \"./completions/_zoxide\" a \"~/.files/shell/zsh/autocomplete/\" ..."
                cp "${l_path_source}/completions/_zoxide" ${g_path_base}/.files/shell/zsh/autocomplete/zoxide.zsh

                echo "Copiando \"./completions/zoxide.elv\" a \"~/.files/shell/others/autocomplete/\" ..."
                cp "${l_path_source}/completions/zoxide.elv" ${g_path_base}/.files/shell/others/autocomplete/zoxide.elv

                echo "Copiando \"./completions/zoxide.ts\" a \"~/.files/shell/others/autocomplete/\" ..."
                cp "${l_path_source}/completions/zoxide.ts" ${g_path_base}/.files/shell/others/autocomplete/zoxide.ts

                echo "Copiando \"./completions/_zoxide.ps1\" a \"~/.files/shell/powershell/autocomplete/\" ..."
                cp "${l_path_source}/completions/_zoxide.ps1" ${g_path_base}/.files/shell/powershell/autocomplete/zoxide.ps1

                if [ ! -z "$g_other_calling_user" ]; then
                    chown $g_other_calling_user ${g_path_base}/.files/shell/bash/autocomplete/zoxide.bash
                    chown $g_other_calling_user ${g_path_base}/.files/shell/fish/autocomplete/zoxide.fish
                    chown $g_other_calling_user ${g_path_base}/.files/shell/zsh/autocomplete/zoxide.zsh
                    chown $g_other_calling_user ${g_path_base}/.files/shell/others/autocomplete/zoxide.elv
                    chown $g_other_calling_user ${g_path_base}/.files/shell/others/autocomplete/zoxide.ts
                    chown $g_other_calling_user ${g_path_base}/.files/shell/powershell/autocomplete/zoxide.ps1
                fi
            fi
            ;;
        ...
        eza)
            ...
            if [ $p_install_win_cmds -ne 0 ]; then
                ...
                if [ $p_artifact_index -eq 1 ]; then
                    ...
                    echo "Copiando \"${l_path_source}/eza\" a \"~/.files/shell/bash/autocomplete/\" ..."
                    cp "${l_path_source}/eza" ${g_path_base}/.files/shell/bash/autocomplete/eza.bash

                    echo "Copiando \"${l_path_source}/_eza\" a \"~/.files/shell/zsh/autocomplete/\" ..."
                    cp "${l_path_source}/_eza" ${g_path_base}/.files/shell/zsh/autocomplete/eza.zsh

                    echo "Copiando \"${l_path_source}/eza.nu\" a \"~/.files/shell/others/autocomplete/\" ..."
                    cp "${l_path_source}/eza.nu" ${g_path_base}/.files/shell/others/autocomplete/eza.nu

                    echo "Copiando \"${l_path_source}/eza.fish\" a \"~/.files/shell/fish/autocomplete/\" ..."
                    cp "${l_path_source}/eza.fish" ${g_path_base}/.files/shell/fish/autocomplete/eza.fish

                    if [ ! -z "$g_other_calling_user" ]; then
                        chown $g_other_calling_user ${g_path_base}/.files/shell/bash/autocomplete/eza.bash
                        chown $g_other_calling_user ${g_path_base}/.files/shell/fish/autocomplete/eza.fish
                        chown $g_other_calling_user ${g_path_base}/.files/shell/zsh/autocomplete/eza.zsh
                        chown $g_other_calling_user ${g_path_base}/.files/shell/others/autocomplete/eza.nu
                    fi
        ...
        yazi)
            ...
            if [ $p_install_win_cmds -ne 0 ]; then
                ...
                #Copiar los archivos de autocompletado
                echo "Copiando \"./completions/yazi.bash\" a \"~/.files/shell/bash/autocomplete/\" ..."
                cp "${l_path_source}/completions/yazi.bash" ${g_path_base}/.files/shell/bash/autocomplete/yazi.bash

                echo "Copiando \"./completions/_yazi\" a \"~/.files/shell/zsh/autocomplete/\" ..."
                cp "${l_path_source}/completions/_yazi" ${g_path_base}/.files/shell/zsh/autocomplete/yazi.zsh

                echo "Copiando \"./completions/yazi.elv\" a \"~/.files/shell/others/autocomplete/\" ..."
                cp "${l_path_source}/completions/yazi.elv" ${g_path_base}/.files/shell/others/autocomplete/yazi.elv

                echo "Copiando \"./completions/yazi.fish\" a \"~/.files/shell/fish/autocomplete/\" ..."
                cp "${l_path_source}/completions/yazi.fish" ${g_path_base}/.files/shell/fish/autocomplete/yazi.fish

                echo "Copiando \"./completions/yazi.nu\" a \"~/.files/shell/others/autocomplete/\" ..."
                cp "${l_path_source}/completions/yazi.nu" ${g_path_base}/.files/shell/others/autocomplete/yazi.nu

                echo "Copiando \"./completions/yazi.ts\" a \"~/.files/shell/others/autocomplete/\" ..."
                cp "${l_path_source}/completions/yazi.ts" ${g_path_base}/.files/shell/others/autocomplete/yazi.ts

                echo "Copiando \"./completions/_yazi.ps1\" a \"~/.files/shell/powershell/autocomplete/\" ..."
                cp "${l_path_source}/completions/_yazi.ps1" ${g_path_base}/.files/shell/powershell/autocomplete/yazi.ps1


                echo "Copiando \"./completions/ya.bash\" a \"~/.files/shell/bash/autocomplete/\" ..."
                cp "${l_path_source}/completions/ya.bash" ${g_path_base}/.files/shell/bash/autocomplete/ya.bash

                echo "Copiando \"./completions/_ya\" a \"~/.files/shell/zsh/autocomplete/\" ..."
                cp "${l_path_source}/completions/_ya" ${g_path_base}/.files/shell/zsh/autocomplete/ya.zsh

                echo "Copiando \"./completions/ya.elv\" a \"~/.files/shell/others/autocomplete/\" ..."
                cp "${l_path_source}/completions/ya.elv" ${g_path_base}/.files/shell/others/autocomplete/ya.elv

                echo "Copiando \"./completions/ya.fish\" a \"~/.files/shell/fish/autocomplete/\" ..."
                cp "${l_path_source}/completions/ya.fish" ${g_path_base}/.files/shell/fish/autocomplete/ya.fish

                echo "Copiando \"./completions/ya.nu\" a \"~/.files/shell/others/autocomplete/\" ..."
                cp "${l_path_source}/completions/ya.nu" ${g_path_base}/.files/shell/others/autocomplete/ya.nu

                echo "Copiando \"./completions/ya.ts\" a \"~/.files/shell/others/autocomplete/\" ..."
                cp "${l_path_source}/completions/ya.ts" ${g_path_base}/.files/shell/others/autocomplete/ya.ts

                echo "Copiando \"./completions/_ya.ps1\" a \"~/.files/shell/powershell/autocomplete/\" ..."
                cp "${l_path_source}/completions/_ya.ps1" ${g_path_base}/.files/shell/powershell/autocomplete/ya.ps1


                if [ ! -z "$g_other_calling_user" ]; then

                    chown $g_other_calling_user ${g_path_base}/.files/shell/bash/autocomplete/yazi.bash
                    chown $g_other_calling_user ${g_path_base}/.files/shell/fish/autocomplete/yazi.fish
                    chown $g_other_calling_user ${g_path_base}/.files/shell/zsh/autocomplete/yazi.zsh
                    chown $g_other_calling_user ${g_path_base}/.files/shell/others/autocomplete/yazi.nu
                    chown $g_other_calling_user ${g_path_base}/.files/shell/others/autocomplete/yazi.elv
                    chown $g_other_calling_user ${g_path_base}/.files/shell/others/autocomplete/yazi.ts
                    chown $g_other_calling_user ${g_path_base}/.files/shell/powershell/autocomplete/yazi.ps1


                    chown $g_other_calling_user ${g_path_base}/.files/shell/bash/autocomplete/ya.bash
                    chown $g_other_calling_user ${g_path_base}/.files/shell/fish/autocomplete/ya.fish
                    chown $g_other_calling_user ${g_path_base}/.files/shell/zsh/autocomplete/ya.zsh
                    chown $g_other_calling_user ${g_path_base}/.files/shell/others/autocomplete/ya.nu
                    chown $g_other_calling_user ${g_path_base}/.files/shell/others/autocomplete/ya.elv
                    chown $g_other_calling_user ${g_path_base}/.files/shell/others/autocomplete/ya.ts
                    chown $g_other_calling_user ${g_path_base}/.files/shell/powershell/autocomplete/ya.ps1
        ...
        fd)
            ...
            if [ $p_install_win_cmds -ne 0 ]; then
                ...
                #Copiar los script de completado
                echo "Copiando \"autocomplete/fd.bash\" a \"~/.files/shell/bash/autocomplete/\" ..."
                cp "${l_path_source}/autocomplete/fd.bash" ${g_path_base}/.files/shell/bash/autocomplete/fd.bash
                echo "Copiando \"autocomplete/fd.ps1\" a \"~/.files/shell/powershell/autocomplete/\" ..."
                cp "${l_path_source}/autocomplete/fd.ps1" ${g_path_base}/.files/shell/powershell/autocomplete/fd.ps1

                #Fix permisos
                if [ ! -z "$g_other_calling_user" ]; then
                    chown $g_other_calling_user ${g_path_base}/.files/shell/bash/autocomplete/fd.bash
                    chown $g_other_calling_user ${g_path_base}/.files/shell/powershell/autocomplete/fd.ps1
                fi
        ...
        kubelet)
            ...
            mkdir -p ${g_path_base}/.files/etc/kubelet/systemd
            ...
            if [ $l_status -eq 0 ]; then
                ...
                echo "$l_aux" | sed "s:/usr/bin:${l_path_target_bin}:g" > ${g_path_base}/.files/etc/kubelet/systemd/kubelet.service

                #Fix permisos
                if [ ! -z "$g_other_calling_user" ]; then
                    chown -R $g_other_calling_user ${g_path_base}/.files/etc/kubelet/
                fi
        ...
        kubeadm)
            ...
            #Desacargar archivos adicionales para su configuración
            mkdir -p ${g_path_base}/.files/etc/kubeadm
            ...
            if [ $l_status -eq 0 ]; then
                ...
                echo "$l_aux" | sed "s:/usr/bin:${l_path_target_bin}:g" > ${g_path_base}/.files/etc/kubeadm/10-kubeadm.conf

                #Fix permisos
                if [ ! -z "$g_other_calling_user" ]; then
                    chown $g_other_calling_user ${g_path_base}/.files/etc/kubeadm/10-kubeadm.conf
                fi
            fi
        ...
        step)
            ...
            if [ $p_install_win_cmds -ne 0 ]; then
                ...
                #Copiando los script para el autocompletado
                echo "Copiando \"autocomplete/bash_autocomplete\" a \"~/.files/shell/bash/autocomplete/\" ..."
                cp "${l_path_source}/autocomplete/bash_autocomplete" ${g_path_base}/.files/shell/bash/autocomplete/step.bash
                echo "Copiando \"autocomplete/zsh_autocomplete\" a \"~/.files/shell/zsh/autocomplete/\" ..."
                cp "${l_path_source}/autocomplete/zsh_autocomplete" ${g_path_base}/.files/shell/zsh/autocomplete/step.zsh

                #Fix permisos
                if [ ! -z "$g_other_calling_user" ]; then
                    chown $g_other_calling_user ${g_path_base}/.files/shell/bash/autocomplete/step.bash
                    chown $g_other_calling_user ${g_path_base}/.files/shell/zsh/autocomplete/step.zsh
                fi
        ...
        crun)
            ...
            mkdir -p ${g_path_base}/.files/etc/podman
            ...
            curl -fLo ${g_path_base}/.files/etc/podman/storage_default.toml \
            ...
            #Fix permisos
            if [ ! -z "$g_other_calling_user" ]; then
                chown -R $g_other_calling_user ${g_path_base}/.files/etc/podman/
            fi
        ...
        containerd)
            ...
            mkdir -p ${g_path_base}/.files/etc/containerd/systemd_root
            ...
            curl -fLo ${g_path_base}/.files/etc/containerd/systemd_root/containerd.service https://raw.githubusercontent.com/containerd/containerd/main/containerd.service
            ...
            #Fix permisos
            if [ ! -z "$g_other_calling_user" ]; then
                chown -R $g_other_calling_user ${g_path_base}/.files/etc/containerd/
            fi
        ...
        buildkit)
            ...
            #Descargar archivo de configuracion como servicio a nivel system:
            mkdir -p ${g_path_base}/.files/etc/buildkit/systemd_root
            mkdir -p ${g_path_base}/.files/etc/buildkit/systemd_user
            
            printf 'Descargando el archivo de configuracion de "%s" a nivel usuario en "%s"\n' "buildkit.service" "~/.files/etc/buildkit/systemd_user/"
            #curl -fLo ${g_path_base}/.files/etc/buildkit/systemd_user/buildkit.service https://raw.githubusercontent.com/moby/buildkit/master/examples/systemd/user/buildkit-proxy.service
            curl -fLo ${g_path_base}/.files/etc/buildkit/systemd_user/buildkit.service https://raw.githubusercontent.com/moby/buildkit/master/examples/systemd/user/buildkit.service
            printf 'Descargando el archivo de configuracion de "%s" a nivel usuario en "%s"\n' "buildkit.socket" "~/.files/etc/buildkit/systemd_user/"
            curl -fLo ${g_path_base}/.files/etc/buildkit/systemd_user/buildkit.socket https://raw.githubusercontent.com/moby/buildkit/master/examples/systemd/user/buildkit-proxy.socket

            printf 'Descargando el archivo de configuracion de "%s" a nivel sistema en "%s"\n' "buildkit.service" "~/.files/etc/buildkit/systemd_root/"
            curl -fLo ${g_path_base}/.files/etc/buildkit/systemd_root/buildkit.service https://raw.githubusercontent.com/moby/buildkit/master/examples/systemd/system/buildkit.service
            printf 'Descargando el archivo de configuracion de "%s" a nivel sistema en "%s"\n' "buildkit.socket" "~/.files/etc/buildkit/systemd_root/"
            curl -fLo ${g_path_base}/.files/etc/buildkit/systemd_root/buildkit.socket https://raw.githubusercontent.com/moby/buildkit/master/examples/systemd/system/buildkit.socket


            #Fix permisos
            if [ ! -z "$g_other_calling_user" ]; then
                chown -R $g_other_calling_user ${g_path_base}/.files/etc/buildkit/
            fi
        ...
        nerdctl)
            ...
            if [ $p_artifact_index -eq 0 ]; then
                ...
                mkdir -p ${g_path_base}/.files/shell/sh/containerd

                #Archivos para instalar 'containerd' de modo rootless
                echo "Copiando \"${l_path_source}/containerd-rootless.sh\" (tool gestión del ContainerD en modo rootless) a \"~/.files/shell/sh/containerd\" ..."
                cp "${l_path_source}/containerd-rootless.sh" ${g_path_base}/.files/shell/sh/containerd
                chmod u+x ${g_path_base}/.files/shell/sh/containerd/containerd-rootless.sh

                echo "Copiando \"${l_path_source}/containerd-rootless-setuptool.sh\" (instalador de ContainerD en modo rootless)  a \"~/.files/shell/sh/containerd\" ..."
                cp "${l_path_source}/containerd-rootless-setuptool.sh" ${g_path_base}/.files/shell/sh/containerd
                chmod u+x ${g_path_base}/.files/shell/sh/containerd/containerd-rootless-setuptool.sh

                #Fix permisos
                if [ ! -z "$g_other_calling_user" ]; then
                    chown -R $g_other_calling_user ${g_path_base}/.files/shell/sh/containerd/
                fi
        ...
        trivy)
            ...
            mkdir -p ${g_path_base}/.files/etc/trivy/templates
            echo "Copiando templates de \"contrib/*.tpl\" a \"~/.files/etc/trivy/templates/\" ..."
            cp ${l_path_source}/contrib/*.tpl ${g_path_base}/.files/etc/trivy/templates/

            #Fix permisos
            if [ ! -z "$g_other_calling_user" ]; then
                chown -R $g_other_calling_user ${g_path_base}/.files/etc/trivy/
            fi
            ;;
        ...
        13)
            ...
            if [ $g_user_sudo_support -ne 2 ] && [ $g_user_sudo_support -ne 3 ]; then
                ...
                if [ $l_is_noninteractive -eq 1 ]; then
                    ${g_path_base}/.files/shell/bash/setup/linux/04_setup_packages.bash 2 'dotnetlib' $g_status_crendential_storage 1
                    l_status=$?
                else
                    ${g_path_base}/.files/shell/bash/setup/linux/04_setup_packages.bash 4 'dotnetlib' $g_status_crendential_storage 1
                    l_status=$?
                fi
