...
. ${g_path_base}/.files/shell/bash/setup/linux/_setup_packages_custom.bash
...
g_usage() {
    ...
    printf '    %b~/.files/shell/bash/setup/linux/04_setup_packages.bash uninstall\n%b' "$g_color_yellow1" "$g_color_reset"
    printf '  > %bInstalar paquetes mostrando el menú de opciones (interactivo)%b:\n' "$g_color_cian1" "$g_color_reset"
    printf '    %b~/.files/shell/bash/setup/linux/04_setup_packages.bash\n%b' "$g_color_yellow1" "$g_color_reset"
    printf '    %b~/.files/shell/bash/setup/linux/04_setup_packages.bash 0\n%b' "$g_color_yellow1" "$g_color_reset"
    printf '  > %bInstalar/Actualizar un grupo de paquetes sin mostrar el menú%b:\n' "$g_color_cian1" "$g_color_reset"
    printf '    %b~/.files/shell/bash/setup/linux/04_setup_packages.bash CALLING_TYPE MENU-OPTIONS\n%b' "$g_color_yellow1" "$g_color_reset"
    printf '    %b~/.files/shell/bash/setup/linux/04_setup_packages.bash CALLING_TYPE MENU-OPTIONS SUDO-STORAGE-OPTIONS\n%b' "$g_color_yellow1" "$g_color_reset"
    printf '    %bDonde:%b\n' "$g_color_gray1" "$g_color_reset"
    ...
    printf '    %b~/.files/shell/bash/setup/linux/04_setup_packages.bash CALLING_TYPE LIST-REPO-IDS%b\n' "$g_color_yellow1" "$g_color_reset"
    printf '    %b~/.files/shell/bash/setup/linux/04_setup_packages.bash CALLING_TYPE LIST-REPO-IDS SUDO-STORAGE-OPTIONS%b\n' "$g_color_yellow1" "$g_color_reset"
    printf '    %b~/.files/shell/bash/setup/linux/04_setup_packages.bash CALLING_TYPE LIST-REPO-IDS SUDO-STORAGE-OPTIONS UPGRADE-OS-PACKAGES%b\n' "$g_color_yellow1" "$g_color_reset"
    printf '    %bDonde:%b\n' "$g_color_gray1" "$g_color_reset"
