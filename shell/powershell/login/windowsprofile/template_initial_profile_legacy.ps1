...
#   cp ~/.files/shell/powershell/login/windowsprofile/template_initial_profile_legacy.ps1 "${env:USERPROFILE}/initial_profile_legacy.ps1"
#   vim "${env:USERPROFILE}/initial_profile_legacy.ps1"
#
