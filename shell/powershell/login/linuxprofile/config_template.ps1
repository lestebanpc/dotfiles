...
# Si no se establecer (es vacio), se establece el valor por defecto '${env:HOME}/${g_repo_name}/etc/oh-my-posh/lepc-montys-1.omp.json'
#g_prompt_theme= "${env:HOME}/.files/etc/oh-my-posh/lepc-montys-1.omp.json"
