...
if(-not ${g_ohmyposh_theme_path}) {
    $g_ohmyposh_theme_path= "${env:HOME}/.files/etc/oh-my-posh/lepc-montys-1.omp.json"
}

#Write-Host "g_ohmyposh_theme_path2= ${g_ohmyposh_theme_path}"
...
. "${env:HOME}/.files/shell/powershell/profile/linux/_profile_functions.ps1"
