...
3. Opcional. Configuración de los script de instalación/actualización.
   ...
   ```shell
   cp ~/.files/shell/bash/bin/linuxsetup/template_config.bash ~/.files/shell/bash/bin/linuxsetup/template_config.bash
...
7. Opcional. Configuración de su profile del shell del SO:
   ...
   El archivo de configuración por defecto no existe y debe ser creado en '~/.files/shell/bash/profile/_config.bash'.
